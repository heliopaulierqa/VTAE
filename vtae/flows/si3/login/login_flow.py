# vtae/flows/si3/login/login_flow.py
"""
LoginFlow — SI3 Oracle Forms
v0.5.10: migrado para BaseFlow — _step() centralizado, description propagada.
"""
...
class LoginFlow(BaseFlow):
    ...
    def _step_entrar(self, ctx, observer=None):
        ...
        return self._step("L03", "clicar no botao Entrar", fn, observer, ctx=ctx)
