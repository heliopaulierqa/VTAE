...
from vtae.cli.send import enviar_relatorio
...
MODULOS = {
    ...
    "si3": [
        "tests/integration/si3/test_cadastro_paciente_min.py",
...
TESTES = {
    ...
    # O teste PROVISORIO (test_cadastro_min_motor.py) morreu quando a
    # fixture si3 (peca 5) fechou o gate 3x em 06/08 — aponta agora para
    # o teste de producao com o contrato de 3 linhas (Projeto v1.1 §4).
    "cadastro_paciente_min":                 "tests/integration/si3/test_cadastro_paciente_min.py",
...
def _health_check(sistemas_alvo):
    if not sistemas_alvo:
        return
    try:
        from vtae.core.health_check import verificar
